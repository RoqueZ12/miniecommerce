...
import { db } from './../services/auth'; // Se importan las funciones de autenticación y Firestore
...
const decreaseQuantity = async (productId) => {
  ...
  return (
    <CartContext.Provider value={{ cart, addToCart, fetchCart, clearCart, loading, increaseQuantity, decreaseQuantity }}>
